...
class Datatool:
    ...
    def _make_train_val_dir(self):
        self._label_dir_path = os.path.join(self._json_dir, "dataset/labels/")
        self._image_dir_path = os.path.join(self._json_dir, "dataset/images/")
    ...
    def _save_dataset_yaml(self):
        yaml_path = os.path.join(self._json_dir, "dataset/", "dataset.yaml")
